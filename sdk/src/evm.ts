// Minimal EVM client: JSON-RPC, RLP, EIP-1559 transactions signed with a
// secp256k1 key, EIP-191 personal_sign, and ABI encoding of static arguments.
// No dependencies beyond @noble. The same encoders as the control plane
// (control/src/evm.ts), pinned to Foundry's cast in the tests.
...
/** EIP-191 personal_sign: a 65-byte signature as 0x hex (v = 27 or 28). */
